export default function Footer() {
  return (
    <div className="flex items-end w-full  bg-white border-t-2 ">
      <footer className="w-full text-gray-700 bg-gray-200 body-font">
        <div className="container flex flex-col flex-wrap px-5 pt-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
          <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
            ...
            <p className="mt-2 text-2xl text-gray-900">Fresh Cart</p>
            <div className="mt-4">
